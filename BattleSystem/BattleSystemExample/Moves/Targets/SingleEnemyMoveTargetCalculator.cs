...
{
    /// <summary>
    /// Lets the user choose a single enemy as the move target.
    /// </summary>
    public class SingleEnemyMoveTargetCalculator : IMoveTargetCalculator
    {
        /// <summary>
        /// The user input.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="SingleEnemyMoveTargetCalculator"/> instance.
        /// </summary>
        /// <param name="userInput">The user input.</param>
        /// <param name="gameOutput">The game output.</param>
        public SingleEnemyMoveTargetCalculator(IUserInput userInput, IGameOutput gameOutput)
        {
